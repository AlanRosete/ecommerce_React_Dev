            ...
            <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-9">
                ...
                <div className="block lg:hidden">
                    <button
                        ...
                        className={`relative w-8 h-6 flex flex-col justify-between items-center group transition-all duration-300`}
                    >
                    <span
                    className={`block h-[3px] w-full rounded bg-black transform transition-all duration-300 ease-in-out ${
                        isOpen ? 'rotate-45 translate-y-[12px]' : ''
                    }`}
                    ></span>
                    <span
                    className={`block h-[3px] w-full rounded bg-black transition-all duration-300 ease-in-out ${
